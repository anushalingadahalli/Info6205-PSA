...
public class Timer {
    ...
    public <T, U> double repeat(int n, Supplier<T> supplier, Function<T, U> function, UnaryOperator<T> preFunction, Consumer<U> postFunction) {
        ...
        for (int i = 0; i < n; i++)
        {
            //Get  input to the function from supplier
            T t = supplier.get();
            if (preFunction != null){
                //If a preFunction exists, use it for pre-processing that input t to the function
            ...
            //If a postFunction exists, use it to consume the output of the function
    ...
    private static double toMillisecs(long ticks) {
        // TO BE IMPLEMENTED
       // throw new UnsupportedOperationException();
        double toMilli= (double)ticks/1000000;
        return toMilli;
    }
